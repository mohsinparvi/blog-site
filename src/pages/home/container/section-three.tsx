...
const SectionThree = () => {
  return (
    <>
      ...
      <section className="relative bg-dark-hard px-5 bg-tertiary">
        <div className="container grid grid-cols-12 mx-auto py-10 md:pb-20 lg:place-items-center">
          <div className="col-span-12 lg:col-span-6">
            ...
            <p className="text-dark-light text-sm leading-7 mt-6 md:text-center md:text-base lg:text-left text-[#B3BAC5]">
